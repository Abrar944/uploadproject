<?php
 ...
 $db = new mysqli("localhost","root","");
   if($db->connect_errno > 0){
	 ...
	 $db->query("CREATE DATABASE IF NOT EXISTS `Student_db`");
	 
             mysqli_select_db($db,"Student_db");
               ...
               $db->query($stableZ);
			    ...
			    $stable4="CREATE TABLE IF NOT EXISTS Administrator (id int(11) NOT NULL auto_increment,
                   ...
                   $rowcount=mysqli_num_rows($result);
                       ...
                       if($rowcount==0)
                         {
                           $enter="INSERT INTO Administrator (Password,Email,Firstname,Sirname,Mtitle,Phone) VALUES('test123','test@gmail.com','Abdullah','Syed','Mr','8688676965')";
                                  $db->query($enter);
								  
						   
                                                    $querydy = "INSERT INTO Files (Title,Name,Size,Type) ".
                                 "VALUES ('Student','Student.csv','76','application/vnd.ms-excel')";                                 
